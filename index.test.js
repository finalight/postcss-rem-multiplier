...
describe("rem multiplier", () => {
    ...
    it("should handle < 1 values and values without a leading 0", () => {
        ...
        var expected =
            ".rule { margin: 0.5px 0.05rem -0.020000000000000004rem -.2em }";
        var options = {
            propList: ["margin"],
        };
    ...
    describe("value parsing", () => {
        it("should not replace values in double quotes or single quotes", () => {
            ...
            var expected =
                ".rule { content: '1rem'; font-family: \"1rem\"; font-size: 1.6rem; }";
            var processed = postcss(remToPx(options)).process(rules).css;
        ...
        it("should not replace values in `url()`", () => {
            ...
            var expected =
                ".rule { background: url(1rem.jpg); font-size: 1.6rem; }";
            var processed = postcss(remToPx(options)).process(rules).css;
    ...
    describe("selectorBlackList", () => {
        it("should ignore selectors in the selector black list", () => {
            ...
            var expected =
                ".rule { font-size: 1.5rem } .rule2 { font-size: 15rem }";
            var options = {
    ...
    describe("mediaQuery", () => {
        it("should replace rem in media queries", () => {
            ...
            var expected =
                "@media (min-width: 50rem) { .rule { font-size: 1.6rem } }";
            var options = {
                mediaQuery: true,
            };
            var processed = postcss(remToPx(options)).process(rules).css;
